...
- **Mesh & Access**: Server login items with management or SSH URLs, Tailscale ACL policies and host recovery keys, and Kubernetes operator OAuth clients. Kubernetes nodes can reach cluster-scoped Tailscale HTTPS gateways; other lateral access remains tag-specific.
