locals {
  ...
  _services_config_homepage_service_cards = flatten([
  ...
  _services_config_homepage_sort_index = {
    for dashboard_card in concat(local._services_config_homepage_service_cards, local._services_config_homepage_server_cards) : dashboard_card.sort => dashboard_card
  }
  ...
  services_config_homepage = {
    bookmarks = local._services_config_homepage_bookmarks
