# Stage: resolved — expands template strings in server dashboard and data fields.
locals {
  # Server view with dashboard and data fields rendered via templatestring(). Kept
  # separate from service runtime construction so templates receive a consistent,
